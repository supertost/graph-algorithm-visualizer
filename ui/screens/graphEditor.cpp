...
Screen displayGraphEditor(sf::RenderWindow &window, sf::Font &font) {
    ...
    Textbox nodeBox(sf::Vector2f(windowWidth * 0.20f, windowHeight * 0.10f), sf::Vector2f(3.0f, 3.0f), font, 30, sf::Color::Transparent, sf::Color::White, 2.0f, sf::Color(255, 255, 255, 150), "Add a node");
